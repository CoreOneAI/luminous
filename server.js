// server.js — UI + API (with diagnostics)
...
// Permissive CSP for now; we can tighten once CSS/JS are external
...
// Explicit bind to loopback
const server = app.listen(PORT, '127.0.0.1', ()=>{
  const addr = server.address();
  console.log('Luminous listening on', addr);
}).on('error', (err)=>{
